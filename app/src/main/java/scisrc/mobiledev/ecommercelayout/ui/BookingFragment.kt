...
class BookingFragment : Fragment() {
    ...
    private val parks = listOf(
        ParkModel("อุทยานแห่งชาติบึงฉวาก", 1200.0, true, "สุพรรณบุรี", R.drawable.bungchawak,
            "ที่พักในอุทยานแห่งชาติบึงฉวาก ตั้งอยู่ท่ามกลางธรรมชาติ", false, "08:00 - 18:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติปางสีดา", 1000.0, true, "สระแก้ว", R.drawable.pangsida,
            "มีความหลากหลายของธรรมชาติ ทั้งภูเขาและป่าไม้", false, "06:00 - 18:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติเขาใหญ่", 1500.0, true, "นครราชสีมา", R.drawable.khaoyai,
            "ที่พักในอุทยานแห่งชาติเขาใหญ่ อยู่ท่ามกลางธรรมชาติที่อุดมสมบูรณ์", false, "06:00 - 18:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติเอราวัณ", 1200.0, true, "กาญจนบุรี", R.drawable.erawan,
            "อุทยานที่มีน้ำตกสวยงาม 7 ชั้น", false, "08:00 - 17:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติเขาสามร้อยยอด", 1100.0, true, "ประจวบคีรีขันธ์", R.drawable.samroiyot,
            "มีทั้งภูเขา ถ้ำ และชายหาด", false, "06:00 - 18:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติน้ำตกคลองแก้ว", 1000.0, true, "ตราด", R.drawable.khlongkaeo,
            "น้ำตกที่เงียบสงบและธรรมชาติบริสุทธิ์", false, "07:00 - 17:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติเขาชะเมา-เขาวง", 1300.0, true, "ระยอง", R.drawable.khaochamao,
            "น้ำตกและป่าเขาที่เหมาะสำหรับการเดินป่า", false, "06:00 - 18:00 น.", "500  บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติน้ำตกสามหลั่น", 900.0, true, "สระบุรี", R.drawable.samlan,
            "น้ำตกขนาดเล็กในบรรยากาศเงียบสงบ", false, "08:00 - 17:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติน้ำตกเจ็ดสาวน้อย", 1100.0, true, "สระบุรี", R.drawable.chetsaonoi,
            "น้ำตกที่มี 7 ชั้น เหมาะสำหรับการพักผ่อน", false, "08:00 - 17:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติน้ำพอง", 1000.0, true, "ขอนแก่น", R.drawable.namphong,
            "ป่าเขียวขจีและอ่างเก็บน้ำ", false, "06:00 - 18:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติป่าหินงาม", 1300.0, true, "ชัยภูมิ", R.drawable.pahinngam,
            "ทุ่งดอกกระเจียวและหินรูปทรงแปลกตา", false, "06:00 - 18:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติตะรุเตา - จังหวัดสตูล", 1400.0, true, "สตูล", R.drawable.tarutao,
            "หมู่เกาะในทะเลอันดaman", false, "08:00 - 17:00 น.", "500 บาท/คืน", "80 บาท/คืน"),
        ParkModel("อุทยานแห่งชาติศรีพังงา - จังหวัดพังงา", 1200.0, true, "พังงา", R.drawable.sriphangnga,
            "น้ำตกและป่าเขตร้อนชื้น", false, "07:00 - 17:00 น.", "500 บาท/คืน", "80 บาท/คืน")
    )
